...
# Run with:
# docker run -p 5601:5601 -p 9200:9200 -p 5044:5044 -p 5000:5000 -p 5001:5001 -it --name elk <repo-user>/elk
...
ADD ./20-logback-json.conf /etc/logstash/conf.d/20-logback-json.conf
...
EXPOSE 5601 9200 9300 5000 5044 5001 5002/udp
